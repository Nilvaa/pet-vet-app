...
public class Pet_parent_consult_doc extends AppCompatActivity {
    EditText issue,des,date;
    String is,de,da,cl_id,donam,d_id;
    Button req;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_parent_consult_doc);

        Intent i = getIntent();
        cl_id=i.getExtras().getString("cl_id");
        d_id=i.getExtras().getString("d_id");
        donam=i.getExtras().getString("d_nam");

        issue=findViewById(R.id.iss);
        des=findViewById(R.id.des);
        date=findViewById(R.id.date);
        req=findViewById(R.id.btnapp);
        ...
        req.setOnClickListener(v -> {
            ...
            if (is.isEmpty()) {
                Snackbar.make(issue, "Please Enter the issue", Snackbar.LENGTH_LONG)
                ...
                Snackbar.make(des, "Please Enter Explanation", Snackbar.LENGTH_LONG)
                ...
                Snackbar.make(date, "Please Enter starting date of issue", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(Pet_parent_consult_doc.this, "Request sent successful ", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "consult_doc");
                map.put("cid", cl_id);
                map.put("did", d_id);
                map.put("uid", uid);
                map.put("d_nam", donam);
