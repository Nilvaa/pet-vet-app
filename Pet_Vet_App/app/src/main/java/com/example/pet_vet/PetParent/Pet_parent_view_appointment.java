...
public class Pet_parent_view_appointment extends AppCompatActivity {
    ListView dlist;
    List<Petvet_model> arraylist;
    String cl_id;

    public Owner_view_appointments_adaptor adap;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pet_parent_view_appointment);
        dlist=findViewById(R.id.o_view_app);
        Intent i = getIntent();
        cl_id=i.getExtras().getString("cl_id");
        arraylist=new ArrayList<Petvet_model>();


        owners_view_appointment();
    }



    public void owners_view_appointment(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Owner_view_appointments_adaptor(Pet_parent_view_appointment.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "owners_view_appointment");
                map.put("own_id", uid);
