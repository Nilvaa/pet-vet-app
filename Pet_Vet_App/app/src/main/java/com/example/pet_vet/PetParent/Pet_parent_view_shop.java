...
import com.example.pet_vet.adaptor.Owner_view_shop_adaptor;
...
public class Pet_parent_view_shop extends AppCompatActivity {
    ListView cen_list;
    List<Petvet_model> arraylist;

    public Owner_view_shop_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_parent_view_shop);
        cen_list=findViewById(R.id.o_view_shop);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Owner_view_shop_adaptor(Pet_parent_view_shop.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "owners_view_shop");
                return map;
            }
        };
        queue.add(request);
