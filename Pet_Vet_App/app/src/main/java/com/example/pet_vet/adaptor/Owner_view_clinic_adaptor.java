...
public class Owner_view_clinic_adaptor extends ArrayAdapter<Petvet_model> {
    ...
    public Owner_view_clinic_adaptor(Activity context, List<Petvet_model> cen_list) {
        super(context, R.layout.activity_owner_view_clinic_adaptor, cen_list);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.activity_owner_view_clinic_adaptor, null, true);
        ...
        doctor=view.findViewById(R.id.btndoc);
        con=view.findViewById(R.id.btnco);
        confirm();
        con.setOnClickListener(v -> {

            clid=cen_list.get(position).getCen_id();
            cnam=cen_list.get(position).getCen_nam();
            Intent intent=new Intent(getContext(), Pet_parent_view_appointment.class);
        ...
        doctor.setOnClickListener(v -> {
            clid=cen_list.get(position).getCen_id();
            Intent intent=new Intent(getContext(), Pet_parent_view_doc.class);
            Bundle bundle=new Bundle();
            bundle.putString("cl_id",clid);
            intent.putExtras(bundle);
            getContext().startActivity(intent);
    ...
    void confirm() {
        ...
        builder.setMessage(" Consulations will be only visible if you consulted our clinic");
