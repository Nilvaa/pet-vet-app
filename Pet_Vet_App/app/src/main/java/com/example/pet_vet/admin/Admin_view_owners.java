...
public class Admin_view_owners extends AppCompatActivity {
    ListView dlist;
    List<Petvet_model> arraylist;

    public Admin_owner_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_owners);
        dlist=findViewById(R.id.ad_view_owners);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Admin_owner_adaptor(Admin_view_owners.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "admin_view_owners");
                return map;
            }
        };
        queue.add(request);
