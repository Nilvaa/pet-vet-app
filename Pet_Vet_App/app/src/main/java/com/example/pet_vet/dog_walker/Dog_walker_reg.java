...
public class Dog_walker_reg extends AppCompatActivity {
    EditText nam,email,add,phone,pass,lic_num,specil;
    TextView Tv;
    Button sign;
    ...
    Spinner exp;
    String na,em,ad,ph,pas,lic,sp,ex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dog_walker_reg);
        nam=findViewById(R.id.d_nam);
        email=findViewById(R.id.d_em);
        add=findViewById(R.id.d_add);
        phone=findViewById(R.id.d_phone);
        pass=findViewById(R.id.pass);
        lic_num=findViewById(R.id.lic);
        specil=findViewById(R.id.des);
        Tv=findViewById(R.id.tv_reg);
        exp=findViewById(R.id.exp);
        sign=findViewById(R.id.btnreg);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(getApplicationContext(), android.R.layout.simple_spinner_dropdown_item, expe) {
            @Override
        ...
        sign.setOnClickListener(v -> {
            ...
            lic = lic_num.getText().toString();
            ad = add.getText().toString();
            sp = specil.getText().toString();
            ex=exp.getSelectedItem().toString();

            if (na.isEmpty()) {
                Snackbar.make(nam, "Please Enter Name", Snackbar.LENGTH_LONG)
                ...
                Snackbar.make(lic_num, "Please Enter License Number", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                ...
                Snackbar.make(specil, "Please Enter Specializations", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(Dog_walker_reg.this, "Sign Up successful ", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "dog_walker_reg");
                map.put("name", na);
                map.put("address", ad);
                map.put("phone", ph);
                map.put("email", em);
