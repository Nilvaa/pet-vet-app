...
public final class server_005fcontroller_005fpetvet_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (key.equals("owners_view_clinic")) {
        String str3 = "SELECT *FROM `center_reg` WHERE type='Veterinary Clinic'";
        Iterator itr = db.getData(str3).iterator();
        JSONArray jsonarray = new JSONArray();
        if (itr.hasNext()) {
            while (itr.hasNext()) {
...
if (key.equals("owners_view_shop")) {
        String str3 = "SELECT *FROM `center_reg` WHERE type='Pet Shop'";
        Iterator itr = db.getData(str3).iterator();
        JSONArray jsonarray = new JSONArray();
        if (itr.hasNext()) {
            while (itr.hasNext()) {
...
if (key.equals("owners_view_nursery")) {
        String str3 = "SELECT *FROM `center_reg` WHERE type='Pet Nursery'";
        Iterator itr = db.getData(str3).iterator();
        JSONArray jsonarray = new JSONArray();
        if (itr.hasNext()) {
            while (itr.hasNext()) {
